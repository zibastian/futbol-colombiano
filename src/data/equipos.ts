...
export const EQUIPOS: Equipo[] = [
  ...
  { slug: 'internacional-de-bogota', nombre: 'Internacional de Bogotá', oficial: 'Internacional de Bogotá F.C.', apodo: 'El Inter', ciudad: 'Bogotá', estadio: 'Metropolitano de Techo', fundacion: 1982, division: 'A', apiId: 1134, alias: ['La Equidad', 'Equidad', 'Internacional'], descripcion: 'Club sucesor de La Equidad: el grupo estadounidense Tylis–Porter compró la ficha en 2025 y en diciembre presentó la nueva identidad, con blanco, negro y dorado en reemplazo del verde. Debutó con el nombre nuevo en 2026.' },
