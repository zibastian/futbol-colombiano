...
export const EQUIPOS: Equipo[] = [
  ...
  { slug: 'junior-de-barranquilla', nombre: 'Junior de Barranquilla', oficial: 'Club Deportivo Popular Junior F.C. S.A.', apodo: 'El Tiburón', ciudad: 'Barranquilla', estadio: 'Metropolitano Roberto Meléndez', fundacion: 1924, division: 'A', apiId: 1135, alias: ['Junior', 'Atlético Junior'], descripcion: 'El equipo de la costa Caribe, dueño de una de las hinchadas más fervientes del país. Juega en el Metropolitano, casa también de la Selección Colombia. En 2026-I ganó su duodécima estrella tras vencer a Nacional en la final.' },
