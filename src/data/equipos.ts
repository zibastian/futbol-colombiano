...
export const EQUIPOS: Equipo[] = [
  ...
  { slug: 'atletico-junior', nombre: 'Atlético Junior', oficial: 'Club Deportivo Popular Junior F.C. S.A.', apodo: 'El Tiburón', ciudad: 'Barranquilla', estadio: 'Metropolitano Roberto Meléndez', fundacion: 1924, division: 'A', apiId: 1135, alias: ['Junior', 'Junior de Barranquilla', 'Junior FC'], descripcion: 'El equipo de la costa Caribe, dueño de una de las hinchadas más fervientes del país. Juega en el Metropolitano, casa también de la Selección Colombia. En 2026-I ganó su duodécima estrella tras vencer a Nacional en la final.' },
  ...
  { slug: 'deportivo-cali', nombre: 'Deportivo Cali', oficial: 'Asociación Deportivo Cali', apodo: 'El Azucarero', ciudad: 'Cali', estadio: 'Palmaseca', fundacion: 1912, division: 'A', apiId: 1127, alias: ['Cali'], descripcion: 'Primer club colombiano con estadio propio de gran capacidad. Finalista de la Copa Libertadores en 1978 y 1999.' },
  ...
  { slug: 'envigado', nombre: 'Envigado', oficial: 'Envigado Fútbol Club S.A.', apodo: 'La Cantera', ciudad: 'Envigado', estadio: 'Polideportivo Sur', fundacion: 1989, division: 'B', apiId: 1129, alias: ['Envigado FC'], descripcion: 'Reconocido como la mejor cantera del país: de sus divisiones menores salieron James Rodríguez, Juan Fernando Quintero y Giovanni Moreno, entre otros. Descendió al Torneo BetPlay para la temporada 2026.' },
  ...
  { slug: 'internacional-de-bogota', nombre: 'Internacional de Bogotá', oficial: 'Internacional de Bogotá F.C.', apodo: 'El Inter', ciudad: 'Bogotá', estadio: 'Metropolitano de Techo', fundacion: 1982, division: 'A', apiId: 1134, alias: ['La Equidad', 'Equidad', 'Internacional', 'Inter de Bogotá', 'Inter'], descripcion: 'Club sucesor de La Equidad: el grupo estadounidense Tylis–Porter compró la ficha en 2025 y en diciembre presentó la nueva identidad, con blanco, negro y dorado en reemplazo del verde. Debutó con el nombre nuevo en 2026.' },
  ...
  { slug: 'cucuta-deportivo', nombre: 'Cúcuta Deportivo', oficial: 'Cúcuta Deportivo F.C. S.A.', apodo: 'El Motilón', ciudad: 'Cúcuta', estadio: 'General Santander', fundacion: 1924, division: 'A', apiId: 1470, alias: ['Cúcuta'], descripcion: 'Semifinalista de la Copa Libertadores 2007. Regresó a la primera división en 2026 tras consagrarse campeón del Torneo BetPlay.' },
  ...
  { slug: 'independiente-yumbo', nombre: 'Independiente Yumbo', oficial: 'Independiente Yumbo F.C.', ciudad: 'Yumbo', fundacion: 2026, division: 'B', apiId: 27411, alias: ['Atlético Huila', 'Huila', 'Ind. Yumbo'], descripcion: 'Nació en 2026 cuando el Grupo Independiente del Valle trasladó fuera de Neiva la ficha del Atlético Huila —subcampeón de la Liga en 2007 y campeón de la Copa Libertadores Femenina 2018—, poniendo fin a la historia del club opita.' },
